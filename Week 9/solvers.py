...
def optimizeWithCP(x0, A, b, c, h, k, prox_ch, prox_k,
    ...
    while err >= tol:
        ...
        # and using the "linear shift" lemma from lectures we get the following form of CP iterations
        ...
        gamma = alpha
        x_new = prox_k(x - gamma*(rv), gamma)
        rx_new = b - A@x_new
        # *********************************************************************
        # update v
        # *********************************************************************
        # TODO: update x and rx
        v_new = prox_ch(v + gamma*(2*rx_new - rx), gamma)
        rv_new = c - A.T@v_new
        # *********************************************************************
